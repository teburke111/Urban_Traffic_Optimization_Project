...
public class Graph {
    ...
    public Graph(){
        ...
        Street street2 = new Street(node2, node3, 3.2, 2, 0, 0, "Oak Street");
        Street street3 = new Street(node3, node4, 4.0, 3, 0, 0, "Pine Road");
        Street street4 = new Street(node2, node7, 2.8, 1, 0, 2, "Cedar Lane");
        Street street5 = new Street(node3, node8, 3.5, 2, 0, 3, "Birch Blvd");
        Street street6 = new Street(node4, node9, 4.2, 3, 0, 0, "Elm Street");
        Street street7 = new Street(node5, node6, 2.0, 1, 0, 0, "Spruce Way");
        Street street8 = new Street(node5, node7, 3.1, 2, 0, 2, "Willow Drive");
        Street street9 = new Street(node7, node8, 3.7, 2, 0, 0, "Cherry Lane");
        Street street10 = new Street(node8, node9, 4.5, 3, 0, 0, "Poplar Street");
        Street street11 = new Street(node5, node10, 2.3, 1, 0, 2, "Ash Court");
        Street street12 = new Street(node5, node11, 2.9, 2, 0, 0, "Hickory Ave");
        Street street13 = new Street(node11, node12, 3.6, 2, 0, 0, "Walnut Street");
        Street street14 = new Street(node7, node12, 3.3, 2, 0, 3, "Chestnut Blvd");
        Street street15 = new Street(node12, node13, 4.1, 3, 0, 0, "Sycamore Road");
        Street street16 = new Street(node13, node14, 4.8, 3, 0, 6, "Redwood Drive");
        Street street17 = new Street(node11, node15, 2.7, 1, 0, 0, "Dogwood Lane");
        Street street18 = new Street(node15, node16, 3.4, 2, 0, 0, "Magnolia Ave");
        Street street19 = new Street(node12, node16, 3.9, 2, 0, 0, "Aspen Street");
        Street street20 = new Street(node18, node17, 5.0, 3, 0, 0, "Sequoia Blvd");
    ...
    public List<Street> shortestPath(int s, int e) {
        Node start =  null; 
        Node end = null;
